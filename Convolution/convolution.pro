...
#--- Input files ---
HEADERS += src/convolution_cpu.h 
HEADERS += src/convolution_gpu.cuh

SOURCES += src/convolution_main.cpp 
SOURCES += src/convolution_cpu.cpp

#CUDA_HEADERS += 
CUDA_SOURCES += src/convolution_gpu.cu
